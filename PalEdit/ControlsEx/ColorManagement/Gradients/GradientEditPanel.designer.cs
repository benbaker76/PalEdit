namespace ControlsEx.ColorManagement.Gradients
{
	partial class GradientEditPanel
	{
		...
		private void InitializeComponent()
		{
			...
			this.lblColorSelect = new ControlsEx.ColorManagement.ColorLabel();
			this.edit = new ControlsEx.ColorManagement.Gradients.GradientEdit();
		...
		private ControlsEx.ColorManagement.ColorLabel lblColorSelect;
