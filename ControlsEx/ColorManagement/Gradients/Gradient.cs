...
namespace ControlsEx.ColorManagement.Gradients
{
	/// <summary>
	/// ColorBlend object
	/// </summary>
	public class Gradient : ICloneable
	{
		...
		public Color Color
		{
			get { return Color.FromArgb(_alphas.Count > 0 ? (int) (_alphas[0].Alpha * 255) : 0, _colors.Count > 0 ? _colors[0].RGBColor : Color.Empty); }
		}
		#endregion
	...
	public class ColorPoint : Gradient.Point, IComparable<ColorPoint>, ICloneable
	{
		...
		/// ctor
		/// </summary>
		public ColorPoint(Color color, double focus, double point)
			: this(XYZ.FromRGB(new RGB(color)), focus, point)
		{ }
		/// <summary>
		/// ctor
		/// </summary>
