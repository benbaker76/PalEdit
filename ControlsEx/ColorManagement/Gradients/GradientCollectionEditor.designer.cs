...
namespace ControlsEx.ColorManagement.Gradients
{
	partial class GradientCollectionEditor
	{
		...
		private void InitializeComponent()
		{
			...
			this.edit = new ControlsEx.ColorManagement.Gradients.GradientEditPanel();
			...
			this.lstPresets.SelectionChanged += new EventHandler(this.lstPresets_SelectionChanged);
			// 
			// ctxMenu
			// 
